...
- `Installation URL`: The GitHub download link for the latest version, for example: https://github.com/GoldenMinerNetwork/golden-miner-nockchain-gpu-miner/releases/download/v0.4.4/golden_miner_hiveos-0.4.4.tar.gz
...
Alternatively, you can directly use the following JSON configuration. Replace <your-pubkey> with your own public key before using it:
```
{
  "isFavorite": true,
  "items": [
    {
      ...
      "dpool_ssl": false,
      "miner": "custom",
      "miner_alt": "golden_miner_hiveos",
      "miner_config": {
        "algo": "nock",
        "miner": "golden_miner_hiveos",
        "url": "xx",
        "template": "%WAL%",
        "install_url": "https://github.com/GoldenMinerNetwork/golden-miner-nockchain-gpu-miner/releases/download/v0.4.4/golden_miner_hiveos-0.4.4.tar.gz",
        "user_config": "--pubkey=<your-pubkey>"
      },
      "pool_geo": []
    }
  ]
